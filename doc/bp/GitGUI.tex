...
\annotation{Práce se zaměřuje na implementaci programu s grafickým rozhraním, který zprostředkovává přehlednou a intuitivní práci se základními funkcemi systému správy verzí Git. Hlavním ovládacím prvkem programu GitGUI je graf, který by měl pomoci uživateli  orientovat se lépe ve struktuře repozitáře. GitGUI automaticky sleduje změny v souborech pracovního adresáře daného repozitáře i změny v historii repozitáře a tím umožňuje současné používání s jinými nástroji pro Git.}

\annotation[english]{As a part of this thesis, a program with a graphical interface providing intuitive work with basic Git functions was made. The main control of GitGUI is a graph, which is supposed to help better understand the structure of repositories.
\mbox{GitGUI} automatically tracks changes to the working directories of the repositories. It also tracks changes to the repository's history, allowing GitGUI to be used concurrently with other Git tools.}
